...
export function LLMNode({ id }: any) {
  ...
  console.log("LLM OUTPUT TEXT:", output);
  ...
  return (
    <div className="bg-[#212126] border border-[#313135] rounded-2xl w-114.5 h-154.25 text-white px-4 group">
      <button
      ...
      <div className="flex flex-col items-center p-3 h-154">
        <div className="flex items-center w-full gap-3">
          <FcGoogle size={17} />
          <p className="text-[16px] text-white/90 py-3">
            Gemini 2.5 flash
          </p>
        </div>
        ...
        <textarea
          ...
          className="
            mt-2 resize-none rounded-xl
            bg-[#353539] p-3
            text-[13px] text-white/80
            outline-none overflow-y-scroll
            scroll-style w-full h-full
          "
        />
        ...
        <div className="w-full flex justify-between items-center mt-3 font-dm-mono">
          ...
          <button
            ...
            disabled={loading}
            className="
              border border-[#313135] text-white
              text-[15px] mt-2 px-5 py-1
              rounded font-dm-mono cursor-pointer
              flex items-center gap-1
              hover:bg-white/50 hover:text-black/90
              duration-500
            "
          >
